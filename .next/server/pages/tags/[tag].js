...
/* harmony import */ var _lib_generate_rss__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(2399);
/* harmony import */ var _lib_mdx__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(799);
/* harmony import */ var _lib_tags__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(8789);
/* harmony import */ var _lib_utils_kebabCase__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(1938);
...
var __webpack_async_dependencies__ = __webpack_handle_async_dependencies__([_lib_mdx__WEBPACK_IMPORTED_MODULE_4__, _lib_tags__WEBPACK_IMPORTED_MODULE_5__]);
([_lib_mdx__WEBPACK_IMPORTED_MODULE_4__, _lib_tags__WEBPACK_IMPORTED_MODULE_5__] = __webpack_async_dependencies__.then ? (await __webpack_async_dependencies__)() : __webpack_async_dependencies__);
...
async function getStaticProps({
  ...
  const filteredPosts = allPosts.filter(post => post.draft !== true && post.tags.map(t => (0,_lib_utils_kebabCase__WEBPACK_IMPORTED_MODULE_6__/* ["default"] */ .Z)(t)).includes(params.tag)); // rss

  if (filteredPosts.length > 0) {
    const rss = (0,_lib_generate_rss__WEBPACK_IMPORTED_MODULE_3__/* ["default"] */ .Z)(filteredPosts, `tags/${params.tag}/feed.xml`);
    ...
    fs__WEBPACK_IMPORTED_MODULE_7___default().writeFileSync(path__WEBPACK_IMPORTED_MODULE_8___default().join(rssPath, 'feed.xml'), rss);
  }
...
function Tag({
  ...
  return /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_9__.jsxs)(react_jsx_runtime__WEBPACK_IMPORTED_MODULE_9__.Fragment, {
    children: [/*#__PURE__*/react_jsx_runtime__WEBPACK_IMPORTED_MODULE_9__.jsx(_components_SEO__WEBPACK_IMPORTED_MODULE_0__/* .TagSEO */ .$t, {
      title: `${tag} - ${(_data_siteMetadata__WEBPACK_IMPORTED_MODULE_1___default().author)}`,
      description: `${tag} tags - ${(_data_siteMetadata__WEBPACK_IMPORTED_MODULE_1___default().author)}`
    }), /*#__PURE__*/react_jsx_runtime__WEBPACK_IMPORTED_MODULE_9__.jsx(_layouts_ListLayout__WEBPACK_IMPORTED_MODULE_2__["default"], {
      posts: posts,
      title: title
    })]
  });
...
var __webpack_exports__ = __webpack_require__.X(0, [676,664,250,758,673,187,224,399], () => (__webpack_exec__(2867)));
