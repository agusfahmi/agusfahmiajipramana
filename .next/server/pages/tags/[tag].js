...
async function getStaticProps({ params  }) {
    ...
    const filteredPosts = allPosts.filter((post)=>post.draft !== true && post.tags.map((t)=>(0,_lib_utils_kebabCase__WEBPACK_IMPORTED_MODULE_7__/* ["default"] */ .Z)(t)).includes(params.tag));
    // rss
...
var __webpack_exports__ = __webpack_require__.X(0, [676,664,373,59,590,717,795,440], () => (__webpack_exec__(4161)));
